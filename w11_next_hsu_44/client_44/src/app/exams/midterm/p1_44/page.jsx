...
const P1_StaticPage_44 = () => {
  return (
    <Wrapper>
      <div className='shop-page'>
        <div className='section-title'>
          <h3>P1_StaticPage_44</h3>
        ...
        <div className='collection-page'>
          ...
          <div className='items'>
            <div className='collection-item'>
              <img src='/images/midterm/mens/camo-vest.png' />
            ...
            <div className='collection-item'>
              <img src='/images/midterm/mens/floral-shirt.png' />
              <div className='collection-footer'>
            ...
            <div className='collection-item'>
              <img src='/images/midterm/mens/long-sleeve.png' />
              <div className='collection-footer'>
            ...
            <div className='collection-item'>
              <img src='/images/midterm/mens/pink-shirt.png' />
              <div className='collection-footer'>
            ...
            <div className='collection-item'>
              <img src='/images/midterm/mens/roll-up-jean-shirt.png' />
              <div className='collection-footer'>
            ...
            <div className='collection-item'>
              <img src='/images/midterm/mens/polka-dot-shirt.png' />
              <div className='collection-footer'>
...
export default P1_StaticPage_44;
